	  ...
	  ui(new Ui::OBSBasicSettings)
{
	...
	HookWidget(ui->useProxy,             CHECK_CHANGED,  STREAM1_CHANGED);
	HookWidget(ui->socksHost,          EDIT_CHANGED,   STREAM1_CHANGED);
	HookWidget(ui->socksPort,            EDIT_CHANGED,   STREAM1_CHANGED);
	HookWidget(ui->socksUsername,        EDIT_CHANGED,   STREAM1_CHANGED);
	HookWidget(ui->socksPassword,        EDIT_CHANGED,   STREAM1_CHANGED);
